...
public class FOM_Donator
{
    ...
    public FOM_Donator(String name, List<String> ips, Date last_login, String custom_login_message, boolean is_super_donator, boolean is_senior_donator, boolean is_full_donator, List<String> console_aliases, boolean is_activated)
    {
